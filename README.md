...
1. Real-Time Hotel Base Management System: Developed a web-based hotel management system using Java, Spring boot supporting real-time updating data for 1,000+ users.

2. E-commerce Platform: Designed a full-stack application using React and JavaScript, handling secure payments and order tracking.

3. Automation Scripts: Created JavaScript scripts to automate data extraction and analysis, saving 15 hours per week of manual work.

4. Built a real-time crypto currency web application using React.js and Spring boot as backend server for user data storage
MySql database
